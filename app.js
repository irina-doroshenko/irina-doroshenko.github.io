...
var isPlainObject = __webpack_require__(963);
    ...
    if (Object.prototype.hasOwnProperty.call(values, k)) {
      ...
      if (Array.isArray(values[key]) === true) {
        data[key] = values[key].map(function (value) {
          if (Array.isArray(value) === true || (0,isPlainObject/* default */.A)(value)) {
            return prepareDataForValidation(value);
          } else {
            return value !== '' ? value : undefined;
          }
        });
      } else if ((0,isPlainObject/* default */.A)(values[key])) {
...
/* harmony export */   gl: () => (/* binding */ create$8)
/* harmony export */ });
/* unused harmony exports ArraySchema, BooleanSchema, DateSchema, MixedSchema, NumberSchema, ObjectSchema, Schema, StringSchema, TupleSchema, ValidationError, addMethod, array, bool, boolean, date, defaultLocale, getIn, isSchema, lazy, printValue, reach, ref, setLocale, tuple */
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseGetTag_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(383);
/* harmony import */ var _getPrototype_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(647);
/* harmony import */ var _isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(98);
...
// EXTERNAL MODULE: ./node_modules/formik/dist/formik.esm.js + 111 modules
var formik_esm = __webpack_require__(588);
...
var index_esm = __webpack_require__(664);
...
const SignUpSchema = index_esm/* object */.Ik().shape({
  name: index_esm/* string */.Yj().required(requiredErr).min(2, shortNameErr).max(60, longNameErr),
  email: index_esm/* string */.Yj().required(requiredErr).email(invalidEmailErr),
  phone: index_esm/* string */.Yj().required(requiredErr).matches(phoneReqExp, invalidPhoneErr),
  position_id: index_esm/* number */.ai().required(requiredErr),
  photo: index_esm/* mixed */.gl().nullable().required('required').test('is-correct-size', maxFileSizeErr, function (value) {
